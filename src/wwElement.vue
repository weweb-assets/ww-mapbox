  ...
  computed: {
    ...
    markers() {
        ...
        return data.map(marker => ({
            ...
            draggable: wwLib.resolveObjectPropertyPath(marker, draggableField) || this.content.defaultMarkerDraggable || false,
            position: {
  ...
  methods: {
    ...
    loadMarkers() {
      ...
      for (const marker of this.markers) {
        const _marker = new mapboxgl.Marker({color: marker.color, draggable: marker.draggable})
