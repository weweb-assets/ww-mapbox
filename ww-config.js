export default {
  editor: {
    ...
    customSettingsPropertiesOrder: [
        'apiAccessToken',
        ['lat', 'lng', 'zoom'],
        ['markers', 'markersHintFields', 'markersContentField', 'markersLatField', 'markersLngField', 'markersColorField', 'markersDraggableField'],
        ['sources', 'sourcesHintFields', 'sourcesIdField', 'sourcesTypeField', 'sourcesOptionsField'],
        ['layers', 'layersHintFields', 'layersIdField', 'layersTypeField', 'layersSourceField', 'layersSourceLayerField', 'layersOptionsField'],
        [
            'scrollZoom',
            'trackResize',
  ...
  properties: {
    mapStyle: {
      ...
      options: {
          options: [
              { value: 'mapbox://styles/mapbox/streets-v11', label: 'Mapbox Streets' },
              ...
              { value: 'mapbox://styles/mapbox/satellite-streets-v11', label: 'Mapbox Satellite Streets' },
    ...
    apiAccessToken: {
      ...
      type: 'Text',
      options: {
          placeholder: 'pk.eyJ1IjoiYWxleGlzamMiLCJhIjoiY2w2eHUwOXR0MHdrczNncWx2eGMxcXdqbSJ9.qDyDmFSrF81mnB_VkeFPmK',
      },
      defaultValue: '',
    },
    lat: {
    ...
    markers: {
      ...
      options: {
          ...
          item: {
              type: 'Object',
              defaultValue: { content: '', lat: 0, lng: 0, color: '#F23636', draggable: false },
              options: {
                  item: {
                      content: {
                          label: { en: 'Content' },
      ...
      defaultValue: [
          { title: 'New York', content: 'New York, often called New York City (NYC) to distinguish it from the State of New York, is the most populous city in the United States.', lat: 40.712784, lng: -74.005941, color: null, draggable: false },
          { title: 'Brooklyn', content: 'Brooklyn is a borough of New York City, coextensive with Kings County, in the U.S. state of New York.', lat: 40.650002, lng: -73.949997, color: null, draggable: false },
      ],
    },
    markersHintFields: {
    ...
    layers: {
      ...
      options: {
          ...
          item: {
              type: 'Object',
              defaultValue: { id: '', type: '', source: null, sourceLayer: '', options: {} },
              options: {
                  item: {
                      id: {
                          label: { en: 'Unique Id' },
                      ...
                      source: {
                        ...
                        options: content => {
                          return {
                            options: content.sources.map(source => ({label: source.id, value: source.id})),
                          }
                        },
                        bindable: true
                      },
